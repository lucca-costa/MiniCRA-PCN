...
- download.py: Script de download do dataset e do modelo. Necessário porque é grande demais para subir pro Github.
...
- ./output/model/: Diretório contendo o modelo treinado. (necessário executar o script download.py e descomprimir)
